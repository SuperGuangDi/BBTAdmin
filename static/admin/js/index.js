...
//   });
  $("#check-info-page-footer")
    .children("li")
    .each(function() {
      $("#check-info-page-footer").css("background-color", "rgba(255,255,255,0)");
    });
//   for (var i = 0; i < 16; i++) {
// 	//if (typeof $(".info-content").get(i + num * 16) != "undefined") {
//     if ($(".info-content").get(i + num * 16)) {
...
//       $("#check-info-page-footer")
//         .children("li")
//         .get(num).css("background-color","#ff6008");
//     }
//   }
